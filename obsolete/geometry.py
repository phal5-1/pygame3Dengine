...
class Cube:
    def __init__(self, app, texturePath:str = './Image/floorTileNa.png'):
        self.app = app
        self.ctx = app.ctx
        self.vbo = self.get_VBO()
        self.shader_program = self.get_shader_program('default')
        ...
        self.texture = self.get_texture(texturePath) if texturePath != None else None
        self.on_init()
    ...
    def get_vertex_data(self):
        ...
        return numpy.hstack([tex_coord_data, normals, vertex_data])
